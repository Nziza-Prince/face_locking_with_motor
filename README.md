# Face-Locked Servo: Distributed Vision Control
...
### Stage 1: Open-Loop Servo Actuation (Simulation)
- Camera remains fixed on PC
- Servo motor rotates based on face movement
- Camera frame does NOT change when servo rotates
- Validates MQTT messaging, topic isolation, and servo control behavior

### Stage 2: Closed-Loop Tracking (Mechanical Integration)
...
#### Web Dashboard
Open `src/dashboard.html` in a browser. The default WebSocket URL is:
```
